...
//                  if ($counter = 2) break;
        ...
        else { return redirect(site_url('admincp/flashscore/parse_form'));}
...
//         die;
    ...
    function clear_teams()
    {
        ...
        foreach ($teams as $key => $val) {
           ...
           $match_id = $this->team_model->clear_teams($match_fields,$val['ID'],$val['country_id']);
...
//        $content = file_get_contents("http://betz.banujos.ro/app/modules/flashscore/assets/lineups/flashscore_00tRMa0f-lineups.htm"); // cu de toate
//        $content = file_get_contents("http://betz.banujos.ro/app/modules/flashscore/assets/lineups/flashscore_00Qty0Xu-lineups.htm"); // fara coache
