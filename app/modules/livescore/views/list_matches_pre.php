...
<div style="width:auto;text-align:center;" align="center">
            ...
            if (!empty($this->dataset->data)) {
				...
				?>
					<tr>							
		                ...
		                <td align="center" <?php if (!$row['ok_competition'])  { echo 'style="color:red;"'; }?>><b><?=$row['competition_name'];?></b></td>
		                <td align="center"><b><?=$row['match_date'];?></b></td>
                      <td align="center" <?php if (!$row['ok_team1'])  { echo 'style="color:red;"'; }?>><b><?=$row['team1'];?></b></td>
		                <td align="center" <?php if (!$row['ok_team2'])  { echo 'style="color:red;"'; }?>><b><?=$row['team2'];?></b></td>
		                <td align="center"><b><?=$row['score'];?></b></td>                
		                <td align="center"><b><a href="<?=$row['link_match'];?>" target="_blank"><?=$row['link_complete'];?></a></b></td>
		                <td align="center" class="options"><b><a href="/admincp5/livescore/view_match/<?=$row['index'];?>" target="_blank" >view</a></b></td>
		                <td align="center" class="options"><b><a href="/admincp4/livescore/edit_match/<?=$row['index'];?>">edit</a></b></td>
					</tr>
	...
	<tr>
		...
		<td colspan="10">No pre matches.</td>
