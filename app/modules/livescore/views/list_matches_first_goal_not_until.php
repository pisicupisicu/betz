		...
		<ul class="module_links a" style="float:right;margin-top:70px;margin-right:160px;">			
            ...
            if (!empty($this->dataset->data)) {
				...
				?>
					...
					<tr>							
						<td><input type="checkbox" name="check_<?=$row['super_match_id'];?>" value="1" class="action_items" /></td>
		                ...
		                <td align="center" class="options"><b><a href="/admincp5/livescore/view_match/<?=$row['super_match_id'];?>" target="_blank" >view</a></b></td>
		                <td align="center" class="options"><b><a href="/admincp4/livescore/edit_match/<?=$row['super_match_id'];?>">edit</a></b></td>
					</tr>
					<tr>
						<td colspan="11" style="background-color:#F4C2C2">
							<?php
								$minutes = range(1,120);								
