...
class Livescore extends Module {
	...
	*/
	...
	{
            $this->CI->admin_navigation->child_link('livescore',10,'Steps',site_url('admincp/livescore/steps')); 
            ...
            //$this->CI->admin_navigation->child_link('livescore',90,'test',site_url('admincp/livescore/test'));
	}
