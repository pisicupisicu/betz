...
class Livescore extends Module 
{
    ...
    function admin_preload()
    {
        ...
        $this->CI->admin_navigation->child_link('livescore', 30, 'List matches today', site_url('admincp3/livescore/list_matches_today'));
        $this->CI->admin_navigation->child_link('livescore', 31, 'List matches', site_url('admincp/livescore/list_matches'));
        $this->CI->admin_navigation->child_link('livescore', 32, 'List matches with goals and cards', site_url('admincp7/livescore/list_matches'));
        ...
        $this->CI->admin_navigation->child_link('livescore', 70, 'Parse Matches Today', site_url('admincp3/livescore/parse_matches_today'));
        $this->CI->admin_navigation->child_link('livescore', 80, 'Stats Bets', site_url('admincp4/livescore/profit_loss_stats'));
        $this->CI->admin_navigation->child_link('livescore', 90, 'Stats Results', site_url('admincp6/livescore/list_statistics'));
    }
