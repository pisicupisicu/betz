...
class Admincp6 extends Admincp_Controller {
    ...
    {
        $this->load->model(array('livescore/goal_model', 'livescore/card_model'));
...
//        die;
    ...
    {
        $this->load->model(array('livescore/goal_model', 'livescore/card_model', 'livescore/match_model'));
...
//        }
    ...
    {
        $this->load->model(array('match_model', 'goal_model'));
        $this->load->library(array('dataset', 'asciihex'));
    ...
    {
        $this->load->library('dataset');
        $this->load->model(array('method_model', 'country_model', 'bet_model'));
