...
class Admincp2 extends Admincp_Controller {
    ...
    {
        $this->load->library(array('custom_fields/form_builder', 'custom_fields/fieldtype'));
    ...
    function delete_strategy($contents, $return_url)
    {
        ...
        $this->load->model(array('strategy_model', 'step_model'));
    ...
    function steps_recursive($strategy_id, $prev, $amount, $steps, $intermission, $rate, $multiply, $stop)
    {
        ...
        if ($amount >= $stop)
        {
            ...
            $this->steps_recursive($strategy_id, $prev, $amount, $steps, $intermission, $rate, $multiply, $stop);
    }
...
//************************************* BETS LIST*******************************//  
    ...
    function add_bet($action = 'new', $id = false)
    {
        ...
        $this->load->library('admin_form');
        $this->load->model(array('bet_model', 'method_model', 'competition_model', 'user_model', 'market_model', 'country_model'));
    ...
    {
        $this->load->model(array('livescore/bet_model', 'bet_model', 'method_model', 'competition_model', 'market_model', 'country_model', 'user_model'));
...
//********************************** Methods LIST *******************************//           
    ...
    function list_methods()
    {
        ...
        if (isset($_GET['filters']))
        {
            ...
            if (isset($aux['ID_method']))
                $filters['ID_method'] = $aux['ID_method'];
            if (isset($aux['method_name']))
                $filters['method_name'] = $aux['method_name'];
        }
...
//********************************** Countries LIST *******************************//        
    ...
    {
        $this->load->model(array('country_model', 'method_model'));
        // content
...
//********************************** Market LIST *******************************//         
    ...
    function view_markets_selects($id)
    {
        ...
        if (empty($market_select))
            $market_select = array(0 => 'None');
